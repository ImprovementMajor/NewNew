...
while word != guess_word:
    ...
    while True: #forever They will be asking what your letter is until I enter it and after I do they  break the loop
    ...
    # guess_character => 'y'
    guessed_any_correctly = False #  Just to check whether or not the user entered at least anything, it is just beginning of the cycle, and user didn't have a chance to enter anything else. That's why it has False value
    ...
    for index, correct_character in enumerate(word):
        ...
        if correct_character == guess_character:
            guessed_any_correctly = True # Question: Does it mean that if we choose any correct letter despite its position it will give us True? What does guessed_any mean exactly, what's the purpose of it?
            # ['_', '_'...]
            guess_word[index] = guess_character
            # ['y', '_', '_' ... ]


    if guessed_any_correctly:
